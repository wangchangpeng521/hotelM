...
<div class="layui-layout layui-layout-admin" id="layui_layout">
	...
	<div class="layui-side layui-side-bg layui-larry-side" id="larry-side">
		...
		<ul class="layui-nav layui-nav-tree">
			...
			<li class="layui-nav-item layui-this">
				<a href="javascript:;" data-url="adminManagement.jsp">
				    <i class="iconfont icon-jiaoseguanli" data-icon='icon-home1'></i>
					<span>管理员管理</span>
				</a>
			</li>
			<li class="layui-nav-item layui-this">
				<a href="javascript:;" data-url="userManagement.jsp">
				    <i class="iconfont icon-jiaoseguanli2" data-icon='icon-home1'></i>
					<span>用户管理</span>
				</a>
			</li>
			<li class="layui-nav-item layui-this">
				<a href="javascript:;" data-url="intakeManagement.jsp">
				    <i class="iconfont icon-wenzhang1" data-icon='icon-home1'></i>
					<span>入住管理</span>
				</a>
			</li>
			<!-- 系统设置 -->
